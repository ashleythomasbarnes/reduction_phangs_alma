...
# Todd Hunter (NRAO)
# Eric Villard (JAO)
# $Id: almaqa2csg.py,v 2.8 2023/06/12 19:24:54 thunter Exp $
#
"""
...
def version(short=False):
    ...
    """
    myversion = "$Id: almaqa2csg.py,v 2.8 2023/06/12 19:24:54 thunter Exp $"
    if (short):
    ...
    if step in ['SDcalibLine', 'SDcalibCont', 'SDampcal', 'SDscience']:
        ...
        for msName in msNames:
            ...
            if step == 'SDampcal':
                ...
                stext += "  imsize = int(round(1.5*maxsize/cell))\n\n"
    ...
    if fieldIds != []:
        ...
        for ii in range(len(myIntentSources)):
            ...
            if len(myIntentSources[ii]['sourceid']) != 0:
                ...
                sourceFluxes = aU.getALMAFluxForMS(msName, useCalibratorService=useCalibratorService, calibratorServiceURL=calibratorServiceURL)
...
def doApplyBandpassAndGainCalTables(msName, msName1='', iHaveSplitMyScienceSpw=False, bandpass='', phaseForCal='', phaseForSci='', flux='', phaseDiffCalTableName='', ampForSci='', useForLoop=True, valueMaps={}):

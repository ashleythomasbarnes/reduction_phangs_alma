...
pipedir = '/vol/alcina/data1/shared/densegas_acatp/imaging/0-ash/imaging_scripts'

# Location of the master key. Set this to the master key that points
# to all of the keys for your project.

key_file = '/vol/alcina/data1/shared/densegas_acatp/imaging/0-ash/imaging_scripts/phangs-dense_keys/phangsdense_master_key.txt'
...
# this_imh.set_line_products(only=['hcn'])
